...
await build({ entryPoints: ['src/background.js', 'src/popup.js', 'src/vocabulary.js', 'src/settings.js', 'src/demo.js'], bundle: true, outdir: 'dist', format: 'esm', platform: 'browser', target: 'chrome120', minify: true, legalComments: 'linked', loader: { '.css': 'text' } });
